 ...
 */
/* 先加载样式 */
TS['link'] = TS['links']['reset']+TS['links']['bootstrap3']+
              TS['links']['layer']+TS['links']['boot-time']+TS['links']['backend']+TS['links']['guanli'];
//TS.addLink();

define(['jquery','artTemplate','fun','layer','validate','boot_time_cn'],function(j,artTemplate,f,layer,b){
