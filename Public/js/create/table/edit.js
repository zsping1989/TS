...
define(['jquery','fun','validate_cn'
    ...
    bind.verify = function(){ /* 表单验证 */
        j("#edit").validate({
            rules: {
                table:{required:true,noNumber:true},alias:{required:true,noNumber:true},name:{required:true,noNumber:true}            }, messages: {
               table:{"required":"true","noNumber":"true"},alias:{"required":"true","noNumber":"true"},name:{"required":"true","noNumber":"true"}            }, errorPlacement: function(error, element) {
